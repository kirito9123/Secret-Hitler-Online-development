...
// Automatically use the host's IP address (e.g., Radmin VPN IP) for backend connection if playing locally
...
export const COMMAND_SET_BOTS_ENABLED = "set-bots-enabled";
export const COMMAND_SET_LOBBY_SIZE = "set-lobby-size";
