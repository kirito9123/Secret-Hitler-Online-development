...
public class SecretHitlerServer {
    ...
    public static final String COMMAND_SET_BOTS_ENABLED = "set-bots-enabled";
            ...
            try {
                switch (message.getString(PARAM_COMMAND)) {
                    ...
                    case COMMAND_SET_LOBBY_SIZE:
                        if (!lobby.isInGame()) {
                            int targetSize = message.getInt("size");
                            lobby.setTargetLobbySize(targetSize);
                        }
                        break;
                    ...
                    case COMMAND_SET_BOTS_ENABLED:
                        if (!lobby.isInGame()) {
                            boolean botsEnabled = message.getBoolean("botsEnabled");
