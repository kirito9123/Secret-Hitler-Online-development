...
public class Lobby implements Serializable {
    ...
    public static float PLAYER_TIMEOUT_IN_SEC = 120;
    ...
    synchronized public void updateUser(WsContext ctx, String userName) {
        ...
        if (isInGame()) {
            ...
            message.put("botsEnabled", botsEnabled);
    ...
    synchronized public void startNewGame() {
        ...
        cpuPlayers.clear();
        if (botsEnabled && usersInGame.size() < targetLobbySize) {
    ...
    synchronized public boolean isBotsEnabled() {
        return botsEnabled;
    }

    synchronized public void setBotsEnabled(boolean botsEnabled) {
        this.botsEnabled = botsEnabled;
    }

    synchronized public int getTargetLobbySize() {
